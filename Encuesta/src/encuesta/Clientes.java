...
public class Clientes extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("contactos?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Contactos c");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<encuesta.Contactos> toRemove = new ArrayList<encuesta.Contactos>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            encuesta.Contactos c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        encuesta.Contactos c = new encuesta.Contactos();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<encuesta.Contactos> merged = new ArrayList<encuesta.Contactos>(list.size());
            for (encuesta.Contactos c : list) {
    ...
    private java.util.List<encuesta.Contactos> list;
